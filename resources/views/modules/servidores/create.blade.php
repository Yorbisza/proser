...
<div class="container mt-4">
    <div class="row">
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('servidores.store') }}" method="POST" name="proser" id="proser" class="row g-3 needs-validation" novalidate>
                        @csrf
                        @method('POST')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="ip_servidores" name="ip_servidores" required>
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" id="contrasenas" name="password" required>
                                <div class="invalid-feedback">
